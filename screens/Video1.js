    ...
    <View style={styles.video}>
      <View style={[styles.frameParent, styles.parentPosition]}>
        ...
        >
          ...
          />
          <Text style={[styles.acceuil, styles.vidoFlexBox]}>Acceuil</Text>
        </Pressable>
        <Pressable
        ...
        >
          ...
          />
          <Text style={[styles.acceuil, styles.vidoFlexBox]}>Cours</Text>
        </Pressable>
        <Pressable
        ...
        >
          ...
          />
          <Text style={[styles.acceuil, styles.vidoFlexBox]}>Notification</Text>
        </Pressable>
        <Pressable
        ...
        >
          ...
          />
          <Text style={[styles.acceuil, styles.vidoFlexBox]}>Paramètre</Text>
        </Pressable>
      </View>
      <View style={[styles.vidoParent, styles.parentPosition]}>
        <Text style={[styles.vido, styles.vidoFlexBox]}>Vidéo</Text>
        <Pressable
