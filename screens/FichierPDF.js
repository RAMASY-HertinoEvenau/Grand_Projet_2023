...
const FichierPDF = () => {
  ...
  return (
    <View style={styles.fichierPdf}>
      ...
      <View style={[styles.fichierPdfParent, styles.parentPosition]}>
        <Text style={[styles.fichierPdf1, styles.acceuilFlexBox]}>
          Fichier PDF
        </Text>
        <Pressable
